  ...
  { rintro (⟨u, hu⟩|⟨u, hu⟩); obtain ⟨v, hv1, hv2⟩ := zsqrt3.coe_of_is_unit' (is_unit_unit u),
    ...
    { rw hv1 at hu,
      ...
      { exfalso,
        ...
        { have : A = x.conj,
          { rw [←hu, zsqrtd.ext],
            simp only [hxre, zsqrtd.conj_re, eq_self_iff_true, zsqrtd.neg_im, zsqrtd.neg_re,
              and_self, neg_zero, zsqrtd.conj_im] },
          have : x ∈ f ∧ x.conj ∈ f,
          { split,
            { exact hx },
            { rwa [←this] } },
    ...
    { rw hv1 at hu,
      ...
      { cases int.abs_iff v with habsv habsv,
        { exfalso,
          ...
          { intro HH,
            ...
            exact HH.2 },
          { cases h1'; rw h1',
            { simp only [hcoprime, zsqrtd.neg_im, mul_neg_eq_neg_mul_symm, zsqrtd.neg_re] },
            { exact hcoprime.neg_neg } } },
        { rw [habsv, neg_eq_iff_neg_eq] at hv2,
      ...
      { exfalso,
        ...
        { rw [habsv, neg_eq_iff_neg_eq] at hv2,
          ...
          { simp only [neg_neg_iff_pos],
            apply lt_of_le_of_ne h2x.1 (ne.symm hxre) } } } } },
end
